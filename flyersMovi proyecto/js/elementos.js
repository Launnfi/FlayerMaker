...
const ELEMENTOS_DEFECTO = {
  promo: (W, H) => [
    ...
    { id: 'titulo',     tipo: 'texto',      label: 'Título promo',   x: W*.08,  y: H*.52,  escala: 1, rotacion: 0 },
    { id: 'badge',      tipo: 'badge',      label: 'Badge precio',   x: W*.73,  y: H*.56,  escala: 1, rotacion: 0 },
    { id: 'descripcion',tipo: 'texto',      label: 'Descripción',    x: W*.08,  y: H*.72,  escala: 1, rotacion: 0 },
  ...
  'nuevo-servicio': (W, H) => [
    ...
    { id: 'titulo',     tipo: 'texto',      label: 'Nombre servicio',x: W*.055, y: H*.50,  escala: 1, rotacion: 0 },
    { id: 'descripcion',tipo: 'texto',      label: 'Descripción',    x: W*.055, y: H*.66,  escala: 1, rotacion: 0 },
